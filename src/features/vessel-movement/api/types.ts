...
/**
 * Result of a PDF bulk import. Kept in the shared types because the snapshot
 * client and the live API both speak it, even though the snapshot cannot parse
 * PDFs — the import card is disabled rather than removed, so the screen still
